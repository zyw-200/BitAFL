...
QEMU="../TriforceAFL/afl-qemu-system-trace"
...
echo ${KERNEL}
#gdb -q  --args \
AFL_SHOWMAP="../TriforceAFL/afl-showmap -o coverage.txt -QQ --"
AFL_FUZZ="../TriforceAFL/afl-fuzz -i ../TriforceAFL/inputs -o ../TriforceAFL/outputs -QQ --"
${AFL_FUZZ} ${QEMU} -monitor telnet:127.0.0.1:4444,server -m 256 -M ${QEMU_MACHINE} -kernel ${KERNEL} \
    ...
    -nographic \
    -net nic,vlan=0 -net tap,vlan=0,id=net0,ifname=${TAPDEV_0},script=no -net nic,vlan=1 -net socket,vlan=1,listen=:2001 -net nic,vlan=2 -net socket,vlan=2,listen=:2002 -net nic,vlan=3 -net socket,vlan=3,listen=:2003 -aflPanicAddr 8056b888 -aflFile @@| tee ${WORK_DIR}/qemu.final.serial.log
